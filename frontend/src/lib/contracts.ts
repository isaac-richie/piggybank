...
export const CONTRACT_ADDRESS = "0x3F2f48b30FbF9b23E5f44c5a8aF99Cf7802c15a6";
...
export const LOCK_DURATIONS = {
  "3 mins": 180,   // 3 minutes
  "6 mins": 360,   // 6 minutes
  "9 mins": 540,   // 9 minutes
  "12 mins": 720,  // 12 minutes
} as const;

export type LockDuration = keyof typeof LOCK_DURATIONS;

// Contract ABI (complete from deployed contract)
export const TIMELOCK_PIGGY_BANK_ABI = [
  {
    "type": "constructor",
    "inputs": [
      {
    ...
    "outputs": [
      {
        "name": "",
        "type": "tuple",
        "internalType": "struct TimelockPiggyBank.Deposit",
        "components": [
          {
            "name": "amount",
            "type": "uint256",
